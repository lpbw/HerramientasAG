  ...
  <table width="400" border="0" align="center" cellpadding="0">
    <tr>
	  ...
	  <table width="100%" border="0" cellpadding="1" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td colspan="2" valign="top" class="texto_info" scope="row"  background="images/bkg_1.jpg"><div align="center" class="style4 style6"><span class="titulo_tabla">Contacto <? echo $id_cliente?> </span></div></td>
          </tr>
        <tr>
