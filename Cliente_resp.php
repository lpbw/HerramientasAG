...
//    public $telefono_contacto;   
    ...
    public function get($id){
        $consulta  = "
            SELECT Clientes.id, id_cartera,nombre_empresa, direccion_empresa, telefono_empresa, 
                nombre_contacto, email_contacto, telefono_contacto,
                estado,ciudad,industria,
                Industrias.nombre AS industria_nombre,
                Estados.nombre AS estado_nombre, contrasenia,
                Clientes.codigo, rfc, condiciones_pago, moneda_usa, alias, tipo_cliente, objetivo
            FROM Clientes
            LEFT OUTER JOIN Industrias ON Industrias.id = Clientes.industria
            LEFT OUTER JOIN Estados ON Estados.id = Clientes.estado
            WHERE Clientes.id ='$id'";
        //echo $consulta;
        $resultado = mysql_query($consulta) or print("La consulta en objeto Cliente fallo: " . mysql_error());
