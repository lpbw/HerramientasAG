    ...
    <td valign="top" bgcolor="#FFFFFF"><table width="977" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="106"><img src="images/logo_AG.jpg" height="56" /></td>
...
while($row = mysql_fetch_assoc($result) ){?>
            ...
            <div>
              <div align="right" style="float:right; margin:5px 5px 0px 5px"> <a href="#" onClick="<?
                          echo intval($_SESSION['usuario']->id_rol) <= intval($_SESSION['accesos']['supervisor']) ?
                          "setFrame('control_panel.php');":"abrir('cambia_firma_mail.php?id={$_SESSION['usuario']->id}',false);";
                          ?>"> <img src="images/control_panel.png" alt="" width="28" height="28" border="0" /></a></div>
                  <div align="center" style="float: right;margin:5px 5px 0px 5px"><a href="#" class="texto_info" onClick="abrir('adm_tareas.php',false);" >
            ...
            <a href="#" 
               ...
               onClick="setFrame('adm_cotizaciones_p.php','Image1');">
            <img src="images/b_cotizaciones.jpg" alt="" name="Image1" height="50" border="0" id="Image1" /></a>
            
            <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image21','','images/b_clientes_r.jpg',1)"
             onclick="setFrame('adm_clientes.php','Image21');">
             <img src="images/b_clientes.jpg" alt="" name="Image21" height="50" border="0" id="Image21" /></a>
             
             <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image31','','images/b_productos_r.jpg',1)"
             onclick="setFrame('adm_productos.php','Image31');">
            ...
            <div align="right"><a href="v_menu.php" target="_blank" class="texto_chico_gris_bold">
             VISITAS</a></div>
				   
            <div align="right"><a target="_self" href="http://customsoftware.com.mx/hag/Vendedores/home.php" target="_blank" style="font-family: Helvetica; font-size: 13px; font-weight: bold; color: blue;" >
             SEGUIMIENTO A PEDIDOS</a></div>				   
				     
              <div align="right" id="atrasReporteEjecutivo" style="visibility: hidden; margin: -10px 0px 0px 0px; float:right">
              
              <a href="#" onClick="setFrame('reporte_ejecutivo.php');" class="texto_chico_gris">REGRESAR</a> </div></div>
            </div>
      ...
      <tr>
        <td bgcolor="#F2F2F2">
          <div style="!important; -webkit-overflow-scrolling:touch !important; width:973px;" id="divIframe">
            <iframe id="iframe_main" src="adm_cotizaciones_p.php" width="973" 
                    onload='resizeIframe(this);' 
                    style="border:none; margin:0px 0px 0px 0px;overflow:hidden; -webkit-overflow-scrolling:touch !important;"></iframe>
            </div>
          </td>
      </tr>
      <tr>
