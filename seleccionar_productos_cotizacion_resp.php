...
if($_REQUEST['buscar']!=''          || $_REQUEST['codigo_buscar']!=''
        ...
        || $_SESSION['buscadorCotizaciones']['proveedor']!='' || $_REQUEST['submit'])
    {
		  ...
		  ?>
                      ...
                      <tr>
                        <td colspan="4" align="right" class="texto_info_negro"><span class="style6">
                          <input name="comprar" type="button" class="texto_info" id="comprar" onclick="window.location = 'generar_cotizacion_p.php'" value="Aceptar" />
                        </span></td>
                      </tr>
                    </table></td>
                  </tr>
  ...
  $color = 'white';
	while(@mysql_num_rows($resultado)>=$count)
	{
		...
		?>
                ...
                <a href="<? echo $res['archivo_ficha_tecnica'];?>" target="_blank" class="texto_info_negro"><img src="images/pdf.ico" alt="pdf" width="20" /></a>
                <? }?>
              </div></td>
                    <td class="texto_info_negro"><div align="center">
                            <input name="cantidad<? echo $count?>" type="text" id="cantidad<? echo $count?>" size="3"/>
                <div class="agregados" id="agregados<? echo $count?>"></div></div></td>
                    <td align="center" valign="middle" class="texto_info_negro"><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image<? echo $res['id'];?>','','images/carrito_r.jpg',1)" onclick="agregarCarrito(<? echo "$count , ".$res['id']." , ".( ($res['precio']==0 && $res['id_proveedor']==7)?'true':'false' )."";?> )"> 
                    <img src="images/carrito.jpg" alt="" name="Image1" width="29" height="23" border="0" id="Image<? echo $res['id'];?>" /></a></td>
                  </tr>
