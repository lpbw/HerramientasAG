...
<div align="center" style="margin:20px">
  ...
  <table border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
    <tr>
      <td colspan="2" align="right" valign="top" bgcolor="#E3E3E3" class="texto_info_negro"> <div align="center"><? echo $producto->codigo; ?>
        <p><? 
    ...
    <tr>
      <td width="64" align="right" valign="top" bgcolor="#E3E3E3" class="texto_info_negro">Nombre Espa&ntilde;ol</td>
    ...
    <tr bordercolor="#CCCCCC">
      <th colspan="2" valign="top" class="texto_info_negro" scope="row"><input name="attrValue" type="text" id="attrValue"  onchange="cambia_mayusculas(this);" value="" size="43" maxlength="43"></th>
    </tr>
    <tr>
