...
//            $row = mysql_fetch_assoc($result);
            ...
            $cotizacion = new Cotizacion();
            $idCotizacion = $_SESSION['idsBackNext'][ $_REQUEST['limit'] ]['id'];
            $idVersionCotizacion =$_SESSION['idsBackNext'][ $_REQUEST['limit'] ]['id_version'];
            
            $cotizacion -> get( $idCotizacion , $idVersionCotizacion );
            $cotizacion -> setCarritoFromCotizacion();
            $_SESSION['cotizacion'] = $cotizacion;
/*
 *         } else { 
            ?><script>alert('Fin de la lista de cotizaciones buscadas');</script><?             
        }
*/
    }
