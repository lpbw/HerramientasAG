...
if($guardar=="Guardar"){
    ...
    $x = $usuario->update($nombre,$email,$contrasenia,$id_rol,$_SESSION['cambiaUsuario']->id, $id_supervisor,$carteras);
    if($x){
        unset($_SESSION['cambiaUsuario']);
        ?><script>parent.location.reload();</script><?
    }
...
<div align="center" style="margin:20px; overflow:auto">
  ...
  <table border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
    ...
    <tr bordercolor="#CCCCCC">
      <th colspan="2" align="center" valign="top" class="texto_info" scope="row"> <table width="80%" border="0" cellpadding="1" cellspacing="0" bgcolor="#CCCCCC" id="tablaCartera">
        <tr>
        ...
        $consulta  = "SELECT * FROM CarteraClientes 
            WHERE id NOT IN(
                                SELECT id_cartera_clientes FROM CarteraClientes_Usuarios WHERE id_usuario = {$_GET['id']}
                            )
            ORDER BY nombre";
        $resultado = mysql_query($consulta) or print("La consulta lista roles: " . mysql_error());
        if(@mysql_num_rows($resultado)>=1){
		...
		ORDER BY nombre";
            ...
            <div class="divCartera" id="divCartera<? echo $idCartera?>" style="width:100%; height:20px"><div style="float:left"> 
                    <a href="#" class="texto_info" onClick="borrarCartera(<? echo $idCartera?>,'<? echo $carteraNombre?>');" onMouseOver="MM_swapImage('Image86','','images/cerrar_r.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="images/cerrar.jpg" alt="" name="Image86" width="17" height="16" border="0" id="Image86" /></a></div>
        ...
        <div class="divCartera" id="divCartera" style="width:100%;">
              <div style="float:left"> <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image86','','images/cerrar_r.jpg',1)" onClick="borrarCartera('idCartera');"><img src="images/cerrar.jpg" alt="" name="Image86" width="17" height="16" border="0" id="Image86" /></a></div>
              <div style="float:left"> Cartera Nombre
                <input type="hidden" id="id_cartera" name="id_cartera[]" value="idCartera">
              </div>
            ...
            <div class="divCartera" id="divCartera" style="width:100%">
              ...
              <div style="float:left"> <a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image86','','images/cerrar_r.jpg',1)" onClick="borrarCartera('idCartera');"><img src="images/cerrar.jpg" alt="" name="Image86" width="17" height="16" border="0" id="Image86" /></a></div>
                          ...
                          <div style="float:left; padding-left:10px"> Cartera Nombre
                <input type="hidden" id="id_cartera" name="id_cartera[]" value="idCartera">
              </div>
    ...
    <tr bordercolor="#CCCCCC">
      ...
      <td class="style5"><input name="contrasenia" type="password" class="texto_info_negro_forma" id="contrasenia" onClick="setContra(this);" value="<?php echo $usuario->contrasenia; ?>" size="45" maxlength="100" /></td>
    </tr>
    <tr bordercolor="#CCCCCC">
