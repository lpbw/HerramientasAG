...
class Cotizacion extends UploadFiles {
    ...
    public function get($id, $idVersion = 0) {
        $consulta = "SELECT id, id_cotizacion_padre, 
            id_usuario, id_usuario_ultima_modificacion, fecha_ultima_modificacion,
            prioridad, id_cliente, id_estatus, notas_adicionales, LAB, 
            terminos_entrega, extra, tipo_moneda, valor_moneda, iva, subtotal,
            total, idioma, es_version, atencion, referencia, vigencia, fecha_version, id_version, DATE(enviada_cliente_en_fecha) as enviada_cliente_en_fecha, con_iva, id_contacto
            FROM Cotizaciones
            WHERE id ='$id' AND id_version = $idVersion";
    ...
    public function update($cotizacion) {
        ...
        $consulta = "UPDATE Cotizaciones SET 
                id = $cotizacion->id,
                id_usuario_ultima_modificacion = '$cotizacion->id_usuario',
                prioridad = '$cotizacion->prioridad',
                id_cliente = '$cotizacion->id_cliente',
				id_contacto = '$cotizacion->id_contacto',
                notas_adicionales = '$cotizacion->notas_adicionales',
                LAB = '$cotizacion->LAB',
                terminos_entrega = '$cotizacion->terminos_entrega',
                extra = '$cotizacion->extra',
                tipo_moneda = '$cotizacion->tipo_moneda',
                valor_moneda = '$cotizacion->valor_moneda',
                iva = '$cotizacion->iva',
                total = '$cotizacion->total',
                subtotal = '$cotizacion->subtotal',
                idioma = '$cotizacion->idioma',
                id_estatus = '$cotizacion->id_estatus',
                es_version = '$cotizacion->es_version',
                enviada_cliente_en_fecha = '$cotizacion->enviada_cliente_en_fecha',
                atencion = '$cotizacion->atencion',
                referencia = '$cotizacion->referencia',
                vigencia = '$cotizacion->vigencia',
                fecha_version = '$cotizacion->fecha_version',
                id_version = '$cotizacion->id_version',
				con_iva = '$cotizacion->con_iva',
                fecha_ultima_modificacion = DEFAULT
            WHERE id = $this->id AND id_version = $this->id_version";
    ...
    public function setCarritoFromCotizacion() {
        ...
        $query = "SELECT * FROM Cotizaciones_Productos 
            WHERE id_cotizacion = $this->id AND id_version = $this->id_version ORDER BY partida";
