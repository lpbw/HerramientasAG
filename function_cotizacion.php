<?
    ...
    {
        // solo contiene variables del carrito
        /*
    ...
    {
        if(!isset($_SESSION['usuario']) || $_SESSION['usuario']->id=="" || $_SESSION['usuario']->id==0  || $_SESSION['usuario']->id=="0" )
        {
            echo "<script>alert('Tu sesion ha expirado');</script>";
        ...
        if( isset($_SESSION['cotizacion']) && $_SESSION['cotizacion']->id == "" )
        {
            ...
            {
                echo "<script>alert('ERROR: Cotizacion crear NO guardada');</script>";
            }
        ...
        else 
        {
            ...
            {
                echo "<script>alert('".$cotizacion->update( $_SESSION['cotizacion'] )."');</script>";
                echo "<script>alert('ERROR: Cotizacion NO guardada');</script>";
            }
        }
    }
